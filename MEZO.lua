------------------------------------------------
-- This Source Was Developed By (MEZO) @Y_U_A_R.--
--   This Is The Source Channel @Y_U_A_R .   --
--                - 𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ -                 --
--        -- https://t.me/Y_U_A_R --         --
------------------------------------------------ 
...
local TheMEZO = io.open("TheMEZO", 'w')
TheMEZO:write([[
cd $(cd $(dirname $0); pwd)
while(true) do
...
cd $(cd $(dirname $0); pwd)
while(true) do
screen -S TheMEZO -X kill
screen -S TheMEZO ./TheMEZO
done
]])
Run:close()
Redis:del(SshId.."Info:Redis:User:ID");Redis:del(SshId.."Info:Redis:User");Redis:del(SshId.."Info:Redis:Token:User");Redis:del(SshId.."Info:Redis:Token")
os.execute('chmod +x TheMEZO;chmod +x Run;./Run')
end
...
TheMEZO = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..TheMEZO)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=TheMEZO,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,1925760763,1001132193,5049221213}  
...
Status = 0
DevelopersQ = Redis:sismember(TheMEZO.."DevelopersQ:Groups",UserId) 
if UserId == 1925760763 then
Status = true
elseif UserId == 5049221213 then
Status = true
elseif UserId == 1001132193 then
Status = true
...
Status = 0
Developers = Redis:sismember(TheMEZO.."Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheMEZO.."DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheMEZO.."TheBasics:Group"..ChatId,UserId)
TheBasicsQ = Redis:sismember(TheMEZO.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheMEZO.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheMEZO.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(TheMEZO.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(TheMEZO.."Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1925760763 then
Status = '𝑅𝓲𝓞'
elseif UserId == 1001132193 then
Status = 'المبرمج بارلو'
elseif UserId == 5049221213 then
Status = 'مبرمج السورس'
elseif UserId == Sudo_Id then  
...
Status = Redis:get(TheMEZO.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(TheMEZO.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(TheMEZO.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheMEZO.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheMEZO.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheMEZO.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheMEZO.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheMEZO.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheMEZO.."lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheMEZO.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheMEZO.."Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheMEZO.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheMEZO.."Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheMEZO.."Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheMEZO.."Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheMEZO.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheMEZO.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheMEZO.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheMEZO.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheMEZO.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheMEZO.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheMEZO.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheMEZO.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheMEZO.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheMEZO.."Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheMEZO.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheMEZO.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheMEZO.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheMEZO.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheMEZO.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheMEZO.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheMEZO.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheMEZO.."Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheMEZO.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheMEZO.."Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheMEZO.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheMEZO.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheMEZO.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheMEZO.."Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheMEZO.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheMEZO.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheMEZO.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheMEZO.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheMEZO.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheMEZO.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheMEZO.."Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheMEZO.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheMEZO.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheMEZO.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheMEZO.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheMEZO.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheMEZO.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheMEZO.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheMEZO.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheMEZO.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheMEZO.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheMEZO.."BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheMEZO.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheMEZO.."SilentGroup:Group"..ChatId,UserId)
}
end
...
return {
Lock     = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه المسح *',
unLock   = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الكتم *',
lockKid  = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه التقييد *',
lockKick = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n᥀︙خاصيه الطرد *',
Reply    = '[𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ](https://t.me/GB_THOR)\n*— — — — — — — — —\n᥀︙المستخدم ← *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,TheMEZO).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(TheMEZO..'MEZO:Channel:Join')
if Channel then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(TheMEZO.."Lock:channell"..msg_chat_id) then
print(Redis:get(TheMEZO.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(TheMEZO.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(TheMEZO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(TheMEZO) then
...
if tonumber(msg.sender.user_id) == 1925760763 then
msg.Name_Controller = '𝑅𝓲𝓞'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 1001132193 then
...
elseif Redis:sismember(TheMEZO.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheMEZO.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheMEZO.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(TheMEZO.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(TheMEZO.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheMEZO.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(TheMEZO.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheMEZO.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheMEZO.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheMEZO.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheMEZO.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheMEZO.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheMEZO.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheMEZO.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheMEZO) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheMEZO.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheMEZO.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMEZO.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheMEZO.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheMEZO) then
return false
end
local floods = Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheMEZO.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheMEZO.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheMEZO.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(TheMEZO.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheMEZO.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheMEZO.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheMEZO.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheMEZO.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheMEZO.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheMEZO.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheMEZO.."lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMEZO.."Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheMEZO.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheMEZO.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheMEZO.."Lock:Bot:kick"..msg_chat_id)
...
local Contact_Group = Redis:get(TheMEZO.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheMEZO.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheMEZO.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheMEZO.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheMEZO.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheMEZO.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheMEZO.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheMEZO.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheMEZO.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheMEZO.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheMEZO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheMEZO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheMEZO.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheMEZO.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheMEZO.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheMEZO.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(TheMEZO.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheMEZO.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheMEZO.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheMEZO.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheMEZO.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheMEZO.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheMEZO.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheMEZO.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheMEZO.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheMEZO.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheMEZO.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheMEZO.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheMEZO.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheMEZO.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheMEZO.."Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheMEZO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheMEZO.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheMEZO.."Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheMEZO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheMEZO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheMEZO.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheMEZO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheMEZO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheMEZO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheMEZO.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheMEZO.."Command:List:Group"..msg_chat_id,text)
Redis:del(TheMEZO.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheMEZO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheMEZO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheMEZO.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheMEZO.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(TheMEZO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMEZO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(TheMEZO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheMEZO.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheMEZO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMEZO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheMEZO.."Group:Rules" .. msg_chat_id,text) 
Redis:del(TheMEZO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheMEZO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMEZO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheMEZO.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMEZO.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMEZO.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheMEZO.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMEZO.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheMEZO.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMEZO.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheMEZO.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheMEZO.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حفظ رد للمدير بنجاح \n᥀︙ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheMEZO.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheMEZO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMEZO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheMEZO.."List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️  ⁦', url='https://t.me/GB_THOR'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheMEZO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMEZO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheMEZO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMEZO.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheMEZO.."Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheMEZO.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheMEZO.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheMEZO.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheMEZO.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheMEZO.."Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheMEZO.."Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheMEZO.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheMEZO.."Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheMEZO.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(TheMEZO.."Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheMEZO.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheMEZO.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheMEZO.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheMEZO.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheMEZO.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheMEZO.."Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheMEZO.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheMEZO.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheMEZO.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheMEZO.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheMEZO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMEZO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMEZO.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMEZO.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheMEZO.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheMEZO.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMEZO.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheMEZO.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMEZO.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheMEZO.."Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMEZO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheMEZO.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheMEZO.."List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheMEZO..'MEZO:'..v..text)
end
Redis:del(TheMEZO.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMEZO.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم حذف الرد من ردود المطور","md",true)  
end
end
if Redis:get(TheMEZO.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheMEZO.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheMEZO.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheMEZO.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheMEZO.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMEZO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(TheMEZO..'MEZO:Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMEZO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(TheMEZO.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMEZO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(TheMEZO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء الاذاعه بالتوجيه خاص","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(TheMEZO.."Num:User:Pv")   
LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم التوجيه الى *- "..#list.." * مجموعه في البوت ","md",true) 
for k,v in pairs(list) do  
...
Redis:set(TheMEZO..'MEZO:Texting:DevTheMEZO',text)
Redis:del(TheMEZO..'MEZO:GetTexting:DevTheMEZO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم حفظ كليشة المطور')
end
if Redis:get(TheMEZO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ᥀︙ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(TheMEZO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMEZO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMEZO.."Set:Id:Groups"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ᥀︙ تم تعين الايدي عام',"md",true)  
end
if Redis:get(TheMEZO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheMEZO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMEZO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMEZO.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:get(TheMEZO.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(TheMEZO.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheMEZO.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(TheMEZO.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر ⌔' then   
Redis:del(TheMEZO.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n᥀︙تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(TheMEZO.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheMEZO.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "᥀︙ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheMEZO.."Game:Smile"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Smile"..msg.chat_id) then
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."Game:Smile"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - سمايل او سمايلات","md",true)  
end
end 
if Redis:get(TheMEZO.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Monotonous"..msg.chat_id) then
Redis:del(TheMEZO.."Game:Monotonous"..msg.chat_id)
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - الاسرع او ترتيب","md",true)  

end
end 
if Redis:get(TheMEZO.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Riddles"..msg.chat_id) then
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."Game:Riddles"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - حزوره","md",true)  

end
end
if Redis:get(TheMEZO.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."Game:Meaningof"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - معاني","md",true)  

end
end
if Redis:get(TheMEZO.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Reflection"..msg.chat_id) then
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."Game:Reflection"..msg.chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙لقد فزت في اللعبه \n᥀︙اللعب مره اخره وارسل - العكس","md",true)  

end
end
if Redis:get(TheMEZO.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheMEZO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMEZO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMEZO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheMEZO.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheMEZO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheMEZO.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMEZO.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheMEZO.."Game:Difference"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Difference"..msg.chat_id) then 
Redis:del(TheMEZO.."Game:Difference"..msg.chat_id)
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheMEZO.."Game:Example"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Example"..msg.chat_id) then 
Redis:del(TheMEZO.."Game:Example"..msg.chat_id)
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMEZO..'MEZO:Channel:Join')}, },}}
...
if tonumber(TheMEZO) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(TheMEZO..'MEZO:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(TheMEZO.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheMEZO.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheMEZO.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheMEZO.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheMEZO.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheMEZO.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(TheMEZO) then 
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(TheMEZO.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheMEZO.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheMEZO.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheMEZO.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheMEZO.."TheBasics:Group"..idg,idASAS)
end;end
end
...
local StatusMember = LuaTele.getChatMember(UserId_Info.id,TheMEZO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n᥀︙البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheMEZO..'MEZO:Channel:Join',ChannelUser) 
...
download('https://raw.githubusercontent.com/MaLaTH-M/MEZO/main/MEZO.lua','MEZO.lua')
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ''..Redis:get(TheMEZO..'MEZO:Channel:Join:Name')..'', url = 't.me/'..Redis:get(TheMEZO..'MEZO:Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'\n• يجب عليك الاشتراك في القناه',"md",false, false, false, false, reply_markup)
end
Redis:del(TheMEZO.."SendBcBot") 
...
Redis:set(TheMEZO.."SendBcBot",true) 
...
Redis:set(TheMEZO.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(TheMEZO.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheMEZO.."AddSudosNew"..msg_chat_id)
...
Redis:set(TheMEZO.."AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(TheMEZO..'ChekBotAdd')  
local UsersBot = Redis:smembers(TheMEZO..'Num:User:Pv')  
local Get_Json = '{"BotId": '..TheMEZO..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(TheMEZO.."TheBasics:Group"..v)
local Constructor = Redis:smembers(TheMEZO.."Originators:Group"..v)
local Manager = Redis:smembers(TheMEZO.."Managers:Group"..v)
local Admin = Redis:smembers(TheMEZO.."Addictive:Group"..v)
local Vips = Redis:smembers(TheMEZO.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
local Groups = Redis:smembers(TheMEZO..'MEZO:ChekBotAdd')  
for k,ide in pairs(Groups) do   
listrep = Redis:smembers(TheMEZO.."List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheMEZO.."Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheMEZO.."Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheMEZO.."Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheMEZO.."Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheMEZO.."Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheMEZO.."Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheMEZO.."Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheMEZO.."Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheMEZO.."Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheMEZO.."Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheMEZO.."Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheMEZO.."List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheMEZO.."Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
LuaTele.sendText(msg_chat_id,msg_id,'*᯽︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᯽︙عدد المجموعات : '..(Redis:scard(TheMEZO..'ChekBotAdd') or 0)..'\n᯽︙عدد المشتركين : '..(Redis:scard(TheMEZO..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(TheMEZO.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheMEZO..'MEZO:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheMEZO..'MEZO:Num:Add:Bot'),"md",true)  
end
...
{
{text = '𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ', url = 't.me/GB_THOR'},
},
}
}
if not msg.ControllerBot then
...
Redis:sadd(TheMEZO.."ChekBotAdd",msg_chat_id)
Redis:set(TheMEZO.."Status:Id"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:Reply"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:BanId"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheMEZO.."BotFree") then
...
Redis:sadd(TheMEZO.."ChekBotAdd",msg_chat_id)
Redis:set(TheMEZO.."Status:Id"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:Reply"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:BanId"..msg_chat_id,true) ;Redis:set(TheMEZO.."Status:SetId"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙المجموعه : {*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*}\n᥀︙تم تفعيل المجموعه اظغط رفع الادمنيه الرفع مالك الجروب ⚠️ *','md', true, false, false, false, reply_markup)
end
end
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheMEZO.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheMEZO.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheMEZO.."ChekBotAdd",msg_chat_id) then
Redis:incr(TheMEZO..'MEZO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(TheMEZO.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(TheMEZO..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(TheMEZO..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheMEZO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheMEZO.."Set:Id:Groups") or Redis:get(TheMEZO.."Set:Id:Group"..msg_chat_id)
if Redis:get(TheMEZO.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(TheMEZO..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(TheMEZO..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(TheMEZO.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(TheMEZO.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(TheMEZO.."Set:Id:Group"..msg.chat_id,Text_Rand)
...
{{text =news,url = "https://t.me/GB_THOR"}, },}}
...
if text == "نبذتي" or text == "البايو" then
local  bain = LuaTele.getUserFullInfo(msg.sender.user_id)
if  bain.bio then
Bio =  bain.bio
else
Bio = 'لا يوجد'
...
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalEdit = Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
if UserInfo.username then
UserInfousername = '@'..UserInfo.username..''
else
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,TheMEZO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'᥀︙البوت عضو في المجموعه ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,TheMEZO).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✔️ ❭' else change_info = '❬ ❌ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(TheMEZO.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMEZO.."DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ᥀︙تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(TheMEZO.."DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheMEZO.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Developers:Groups",UserId) 
...
if not Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMEZO.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ᥀︙تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ᥀︙تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Developers:Groups",UserId) 
...
if Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ᥀︙تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheMEZO.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheMEZO.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheMEZO.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheMEZO.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*᥀︙قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheMEZO.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheMEZO.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheMEZO.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Status:Id"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."BotFree",true) 
...
Redis:set(TheMEZO.."TwaslBot",true) 
...
Redis:set(TheMEZO.."MEZO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMEZO.."MEZO1:List:Rd:Sudo"..msg.chat_id, text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(TheMEZO..'MEZO1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(TheMEZO..'MEZO1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(TheMEZO..'MEZO1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(TheMEZO.."MEZO1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMEZO.."MEZO1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(TheMEZO.."MEZO1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(TheMEZO.."MEZO1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(TheMEZO.."MEZO1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(TheMEZO.."MEZO1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(TheMEZO.."MEZO1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(TheMEZO.."MEZO1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMEZO.."MEZO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMEZO.."MEZO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(TheMEZO.."MEZO1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMEZO.."MEZO1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(TheMEZO.."MEZO1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(TheMEZO.."MEZO1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(TheMEZO.."MEZO1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(TheMEZO.."MEZO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(TheMEZO.."MEZO11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(TheMEZO..'MEZO11:Add:Rd:Sudo:Text'..text)
Redis:del(TheMEZO..'MEZO11:Add:Rd:Sudo:Text1'..text)
Redis:del(TheMEZO..'MEZO11:Add:Rd:Sudo:Text2'..text)
Redis:del(TheMEZO.."MEZO11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(TheMEZO.."MEZO11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(TheMEZO.."MEZO11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(TheMEZO.."MEZO11:Add:Rd:Sudo:Text"..v) 
Redis:del(TheMEZO.."MEZO11:Add:Rd:Sudo:Text1"..v) 
Redis:del(TheMEZO.."MEZO11:Add:Rd:Sudo:Text2"..v)   
Redis:del(TheMEZO.."MEZO11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(TheMEZO.."MEZO11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(TheMEZO.."MEZO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(TheMEZO.."MEZO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(TheMEZO.."MEZO11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(TheMEZO.."MEZO11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(TheMEZO.."MEZO11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(TheMEZO.."MEZO11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(TheMEZO.."MEZO11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(TheMEZO.."allM"..msg.chat_id, msg.id)
if Redis:get(TheMEZO.."Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheMEZO.."allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheMEZO.."allM"..msg.chat_id)
...
Redis:del(TheMEZO.."allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheMEZO.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(TheMEZO.."allM"..msg.chat_id)  
...
Redis:del(TheMEZO.."Status:Del:Media"..msg.chat_id)
...
Redis:set(TheMEZO.."Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheMEZO.."Status:yt"..msg.chat_id)
...
Redis:set(TheMEZO.."Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheMEZO.."Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheMEZO.."Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheMEZO.."Status:Welcome"..msg_chat_id) 
...
Redis:del(TheMEZO.."Status:Id"..msg_chat_id) 
...
Redis:del(TheMEZO.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheMEZO.."Status:Reply"..msg_chat_id) 
...
Redis:del(TheMEZO.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheMEZO.."Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(TheMEZO.."BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMEZO.."BanAll:Groups",UserId_Info.id) 
...
if Controller(msg_chat_id,UserId_Info.id) == '1925760763' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == '1001132193' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == '5049221213' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ᥀︙ عذرا لا تستطيع كتم عام『 "..Controller(msg_chat_id,UserId_Info.id).." 』*","md",true)  
end
if Redis:sismember(TheMEZO.."ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ᥀︙ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMEZO.."ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMEZO.."Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
...
if not Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
Redis:sadd(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if not Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMEZO.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId) then
...
Redis:sadd(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"᥀︙تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if not Redis:get(TheMEZO.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMEZO.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMEZO.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == 'ريو' or text == 'مبرمج السورس' or text == 'سوريا' then  
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝑅𝓲𝓞 ❳', url = "https://t.me/Y_U_A_R"}
},
{
{text = '❲ 𝑆𝑂𝑈𝑅𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️  ❳', url = "https://t.me/GB_THOR"},
},
...
if text == 'المبرمج بارلو' or text == 'بارلو' then  
...
local photo = LuaTele.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ𝙎َِ𝙊َِ𝙤ِ𝙐َِ𝙍َ𝙘ِ𝙀َ َِ𝙏َِ𝙃ِ𝙊𝙤َ𝙍َِ  ✪₅ ,❳\n— — — — — — — — —\n ✵ *Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✵  *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = Creat, url = "https://t.me/"..ban.username..""},
...
if text == 'غزال' or text == 'غزال حازم' then  
...
if not msg.ControllerBot and not Redis:set(TheMEZO.."LeftBot") then
...
Redis:set(TheMEZO.."Lock:text"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheMEZO.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheMEZO.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMEZO..'MEZO:'..lock..msg_chat_id,"del")    
end
...
Redis:del(TheMEZO.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheMEZO.."Lock:text"..msg_chat_id)  
...
Redis:del(TheMEZO.."Lock:Join"..msg_chat_id)  
...
Redis:del(TheMEZO.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheMEZO.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheMEZO.."lockpin"..msg_chat_id)  
...
Redis:del(TheMEZO.."Lock:edit"..msg_chat_id) 
...
Redis:del(TheMEZO.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheMEZO..'MEZO:'..lock..msg_chat_id)    
end
...
if tonumber(Message_Reply.sender.user_id) == tonumber(1925760763) then
return LuaTele.sendText(msg_chat_id,msg_id,"*🚫| حبيبي دا المبرمج سوريا مش بيتف عليه*","md",true)  
end
if tonumber(Message_Reply.sender.user_id) == tonumber(TheMEZO) then
...
if Redis:get(TheMEZO.."Status:kool"..msg.chat_id) then
...
local rd_zwag = {"تم رفعه متوحد في المجموعه 😂",
}
if Redis:sismember(TheMEZO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(TheMEZO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
...
local rd_zwag = {"تم رفعه كلب في المجموعه 😂",
}
if Redis:sismember(TheMEZO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(TheMEZO..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
...
if not Redis:get(TheMEZO.."rb:bna"..msg_chat_id) then
...
Redis:hset(TheMEZO.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheMEZO.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheMEZO.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheMEZO.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheMEZO.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheMEZO.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Link"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Photo"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Video"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Animation"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:geam"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Audio"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:vico"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:forward"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Document"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Contact"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Spam"..msg_chat_id)  
...
Redis:set(TheMEZO.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheMEZO.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(TheMEZO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(TheMEZO.."Status:Welcome"..msg_chat_id) then
...
Redis:del(TheMEZO.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheMEZO.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheMEZO.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"᥀︙تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheMEZO.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheMEZO.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMEZO.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheMEZO.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheMEZO.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheMEZO.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheMEZO.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*᥀︙ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheMEZO.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheMEZO.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheMEZO.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheMEZO.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheMEZO.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."Status:AddMe"..msg.chat_id) then
...
data = {
{
{text = '- قناة السورس', url = 't.me/GB_THOR'}, 
},
}
}
...
if Redis:sismember(TheMEZO..'MEZO:Originators:Group'..msg_chat_id, Message_Reply.sender.user_id) then
cr = "منشئ ،" else cr = "" end
if Redis:sismember(TheMEZO..'MEZO:Managers:Group'..msg_chat_id, Message_Reply.sender.user_id) then
own = "مدير ،" else own = "" end
if Redis:sismember(TheMEZO..'MEZO:Addictive:Group'..msg_chat_id, Message_Reply.sender.user_id) then
mod = "ادمن ،" else mod = "" end
if Redis:sismember(TheMEZO..'MEZO:Distinguished:Group'..msg_chat_id, Message_Reply.sender.user_id) then
vip = "مميز ،" else vip = ""
end
if The_ControllerAll(Message_Reply.sender.user_id) == true then
Rink = 1
elseif Redis:sismember(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
if Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id, UserId_Info.id) then
crr = "منشئ اساسي ،" else crr = "" end
if Redis:sismember(TheMEZO..'MEZO:Originators:Group'..msg_chat_id, UserId_Info.id) then
cr = "منشئ ،" else cr = "" end
if Redis:sismember(TheMEZO..'MEZO:Managers:Group'..msg_chat_id, UserId_Info.id) then
own = "مدير ،" else own = "" end
if Redis:sismember(TheMEZO..'MEZO:Addictive:Group'..msg_chat_id, UserId_Info.id) then
mod = "ادمن ،" else mod = "" end
if Redis:sismember(TheMEZO..'MEZO:Distinguished:Group'..msg_chat_id, UserId_Info.id) then
vip = "مميز ،" else vip = ""
end
if The_ControllerAll(UserId_Info.id) == true then
Rink = 1
elseif Redis:sismember(TheMEZO.."Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(TheMEZO..'MEZO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheMEZO..'MEZO:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheMEZO..'MEZO:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد رسائلك هنا *~ '..(Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد التعديلات هنا *~ '..(Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'᥀︙عدد جهاتك المضافه هنا *~ '..(Redis:get(TheMEZO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheMEZO.."Set:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ᥀︙ ارسل الان النص
 ᥀︙ يمكنك اضافه :
...
Redis:del(TheMEZO.."Set:Id:Groups")
...
Redis:setex(TheMEZO.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
᥀︙ارسل الان النص
᥀︙يمكنك اضافه :
᥀︙`#username` » اسم المستخدم
...
Redis:del(TheMEZO.."Set:Id:Group"..msg.chat_id)
...
Redis:del(TheMEZO.."DevelopersQ:Groups") 
...
Redis:del(TheMEZO.."Developers:Groups") 
...
Redis:del(TheMEZO.."TheBasicsQ:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."Originators:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."Managers:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."Addictive:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."BanAll:Groups") 
...
Redis:del(TheMEZO.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheMEZO.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheMEZO.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheMEZO.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheMEZO.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheMEZO.."List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheMEZO.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheMEZO.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMEZO.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheMEZO.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheMEZO.."Add:Rd:Sudo:Gif"..v)   
Redis:del(TheMEZO.."Add:Rd:Sudo:vico"..v)   
Redis:del(TheMEZO.."Add:Rd:Sudo:stekr"..v)     
Redis:del(TheMEZO.."Add:Rd:Sudo:Text"..v)   
Redis:del(TheMEZO.."Add:Rd:Sudo:Photo"..v)
Redis:del(TheMEZO.."Add:Rd:Sudo:Video"..v)
Redis:del(TheMEZO.."Add:Rd:Sudo:File"..v)
Redis:del(TheMEZO.."Add:Rd:Sudo:Audio"..v)
Redis:del(TheMEZO.."Add:Rd:Sudo:video_note"..v)
Redis:del(TheMEZO.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheMEZO.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(TheMEZO.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMEZO.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMEZO.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:setex(TheMEZO.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheMEZO.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
if text == 'المبرمج سوريا' or text == 'سوريا' or text == 'مبرمج السورس' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
LuaTele.sendText(1925760763,0,'*\n✵  مرحباً عزيزي المبرمج سوريا \nشخص ما يحتاج الي مساعده\nꔹ━━━━━ꔹ𝐅𝐈𝐑𝐄ꔹ━━━━━ꔹ\n✵  اسمه :- '..klajq..' \n✵  ايديه :-  : '..msg.sender.user_id..'\n✵  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج بارلو' or text == 'بارلو' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
LuaTele.sendText(1001132193,0,'*\n✵  مرحباً عزيزي المبرمج بارلو \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝙎َِ𝙊َِ𝙤ِ𝙐َِ𝙍َ𝙘ِ𝙀َ َِ𝙏َِ𝙃ِ𝙊𝙤َ𝙍َِ  ✪₅ ,━━━━⩺ \n✵  اسمه :- '..klajq..' \n✵  ايديه :-  : '..msg.sender.user_id..'\n✵  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'غزال' or text == 'حازم' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
...
LuaTele.sendText(5049221213,0,'*\n✵  مرحباً عزيزي مطور السورس \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ𝙎َِ𝙊َِ𝙤ِ𝙐َِ𝙍َ𝙘ِ𝙀َ َِ𝙏َِ𝙃ِ𝙊𝙤َ𝙍َِ  ✪₅ ,━━━━⩺ \n✵  اسمه :- '..klajq..' \n✵  ايديه :-  : '..msg.sender.user_id..'\n✵  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'سوريا' or text == 'مجهول' then  
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if not Redis:get(TheMEZO.."Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
keyboard.inline_keyboard = {
{
{text = '𝑅𝓲𝓞', url = "https://t.me/Y_U_A_R"},{text = '𝙙ٍ𝙚َ𝙫 ₂ •', url = "https://t.me/bar_lo0o0"}
},
{
...
if text == '،' or text == '،،،' then
if not Redis:get(TheMEZO.."Sasa:Jeka"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
...
data = {
{
{text = '𝑆𝑂????𝐶𝐸 𝑇𝐻𝑂𝑅 🕷️ ', url = 't.me/GB_THOR'}, 
},
}
}
...
Redis:setex(TheMEZO.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local NamesBot = (Redis:get(TheMEZO.."Name:Bot") or "ثور")
local BotName = {
...
if text == (Redis:get(TheMEZO.."Name:Bot") or "ثور") then
local NamesBot = (Redis:get(TheMEZO.."Name:Bot") or "ثور")
local BotName = {
'نعم يروحي 🌝💙',
'نعم يا قلب '..NamesBot..'',
...
x = x + 1
Redis:srem(TheMEZO..'MEZO:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,TheMEZO)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*᥀︙البوت عظو في المجموعه سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(TheMEZO..'MEZO:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(TheMEZO..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(TheMEZO..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(TheMEZO..'MEZO:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(TheMEZO.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:set(TheMEZO..":lov_Bots"..msg.sender.user_id,"sendlove") 
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال سوريا وبلال'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(TheMEZO..":lov_Bots"..msg.sender.user_id) == "sendlove" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه حب '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(TheMEZO..":lov_Bots"..msg.sender.user_id)
return false
end
if text == "نسبه الكره" or text == "نسبه كره" and msg.reply_to_message_id == 0  then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:set(TheMEZO..":Cick:krh"..msg.sender.user_id,"sendkrhe") 
Text = 'ارسل اسمك واسم الشخص الثاني،  \n مثال اسد و لبوى'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(TheMEZO..":Cick:krh"..msg.sender.user_id) == "sendkrhe" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه كره '..text..' هي : '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(TheMEZO..":Cick:krh"..msg.sender.user_id)
return false
end
if text == "نسبه رجوله" or text == "نسبه الرجوله" and msg.reply_to_message_id == 0  then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:set(TheMEZO..":hauai"..msg.sender.user_id,"senduau") 
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه رجولته \n مثال سوريا'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(TheMEZO..":hauai"..msg.sender.user_id) == "senduau" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه رجوله '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(TheMEZO..":hauai"..msg.sender.user_id)
return false
end
if text == "نسبه الانوثه" or text == "نسبه انوثه"  and msg.reply_to_message_id == 0  then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:set(TheMEZO..":lov_cahgf"..msg.sender.user_id,"oaoaiia") 
Text = 'ارسل اسم الشخص الذي تريد قياس نسبه انوثتها \n مثال روان'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(TheMEZO..":lov_cahgf"..msg.sender.user_id) == "oaoaiia" then
num = {"10","20","30","35","75","34","66","82","23","19","55","8","63","32","27","89","99","98","3","80","49","100","6","0",};
sendnum = num[math.random(#num)]
sl = 'نسبه الانوثه '..text..' هي : \n '..sendnum..'%'
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(TheMEZO..":lov_cahgf"..msg.sender.user_id)
return false
end
if text == "كشف الكدب" or text == "كشف الكذب" and msg.reply_to_message_id == 0  then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:set(TheMEZO..":kahzm"..msg.sender.user_id,"sendnumh") 
Text = 'ارسل لى الجمله لتعرف صدق ام كذب🌚✨'
return LuaTele.sendText(msg_chat_id,msg_id,Text,"md",true) 
end
end
if text and Redis:get(TheMEZO..":kahzm"..msg.sender.user_id) == "sendnumh" then
...
sl = ' ⟨  '..text..'  ⟩ \n '..sendnum..' '
 LuaTele.sendText(msg_chat_id,msg_id,sl,"md",true) 
Redis:del(TheMEZO..":kahzm"..msg.sender.user_id)
return false
end
...
"أثقل ما يوضع في الميزان يوم القيامة مجهول الخلق ",
...
if text == "حذف رد انلاين" then
    ...
    Redis:set(TheMEZO.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id,"true2")
  ...
  if text and text:match("^(.*)$") then
  if Redis:get(TheMEZO.."Set:Manager:rd:inline"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
  ...
  Redis:srem(TheMEZO.."List:Manager:inline"..msg_chat_id.."", text)
  ...
  if text == ("مسح الردود الانلاين") then
    ...
    for k,v in pairs(list) do
        Redis:del(TheMEZO.."Add:Rd:Manager:Gif:inline"..v..msg_chat_id)   
        Redis:del(TheMEZO.."Add:Rd:Manager:Vico:inline"..v..msg_chat_id)   
        Redis:del(TheMEZO.."Add:Rd:Manager:Stekrs:inline"..v..msg_chat_id)     
        Redis:del(TheMEZO.."Add:Rd:Manager:Text:inline"..v..msg_chat_id)   
        Redis:del(TheMEZO.."Add:Rd:Manager:Photo:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:Photoc:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:Video:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:Videoc:inline"..v..msg_chat_id)  
        Redis:del(TheMEZO.."Add:Rd:Manager:File:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:video_note:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:Audio:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Add:Rd:Manager:Audioc:inline"..v..msg_chat_id)
        Redis:del(TheMEZO.."Rd:Manager:inline:v"..v..msg_chat_id)
        Redis:del(TheMEZO.."Rd:Manager:inline:link"..v..msg_chat_id)
    Redis:del(TheMEZO.."List:Manager:inline"..msg_chat_id)
    end
...
Redis:set(TheMEZO.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheMEZO.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:del(TheMEZO.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheMEZO.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:del(TheMEZO.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheMEZO.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheMEZO.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheMEZO.."Game:Difference"..msg.chat_id,name)
...
Redis:set(TheMEZO.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheMEZO.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheMEZO.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'غزال') 
local MEZO_Msg = { 
...
Namebot = MEZO_Msg[math.random(#MEZO_Msg)] 
...
Redis:setex(TheMEZO.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*᥀︙عدد احصائيات البوت الكامله \n— — — — — — — — —\n᥀︙عدد المجموعات : '..(Redis:scard(TheMEZO..'MEZO:ChekBotAdd') or 0)..'\n᥀︙عدد المشتركين : '..(Redis:scard(TheMEZO..'MEZO:Num:User:Pv') or 0)..'*',"md",true)  
end
...
if not msg.ControllerBot then
if Redis:get(TheMEZO.."TwaslBot") and not Redis:sismember(TheMEZO.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheMEZO.."Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheMEZO.."Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(TheMEZO..'MEZO:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,'᥀︙تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(TheMEZO..'MEZO:BaN:In:Tuasl',Info_User)  
...
local inget = Redis:get(TheMEZO..'hmsabots'..ramsesadd[3]..data.sender_user_id)
...
Redis:set(TheMEZO..'hmsabots'..idnum..UserId_Info.id,username[1])
Redis:set(TheMEZO..'hmsabots'..idnum..data.sender_user_id,username[1])
end
end
end
...
Redis:srem(TheMEZO.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(TheMEZO..'*'..'-100'..data.supergroup.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheMEZO.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheMEZO.."Lock:tagservr"..data.message.chat_id) then
...
if Message_Edit.sender.user_id == TheMEZO then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(TheMEZO..'MEZO:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(TheMEZO.."Lock:edit"..data.chat_id) then
...
if tonumber(listYt[1]) == tonumber(IdUser) then
Redis:srem(TheMEZO.."SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(TheMEZO.."BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:del(TheMEZO.."Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(TheMEZO.."MEZO1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(TheMEZO.."Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(TheMEZO.."Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMEZO.."Redis:Id:Group"..ChatId..""..IdUser,true) 
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMEZO.."MEZO1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMEZO.."Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(TheMEZO.."Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(TheMEZO.."Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"* ᥀︙ تم تعطيل ردود السورس العراقيه *").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/unmute_setadmib') then
local UserId = Text:match('(%d+)/unmute_setadmib')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMEZO.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMEZO.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheMEZO.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(TheMEZO..'MEZO:'..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheMEZO.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '- رجوع', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"᥀︙تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."SilentGroup:Group"..ChatId) 
